...
## S4 — Interactions
Runs *alongside* GDPR, not instead of it (Art. 10(5) is the one explicit GDPR carve-out). Suite integration table sourced in `skills/data-minimization/references/regulatory-reference.md` §AI Act × Privacy Suite. Derived/inferred-data rules (`skills/data-minimization/SKILL.md` Step 2b) are the operational bridge.
