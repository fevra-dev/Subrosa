...
> **Source of truth:** the rights matrix and response timelines in this file derive from `regulatory-taxonomy.md` records (`ca-pipeda-law25`, `eu-gdpr-uk`, `us-ca-ccpa`, `br-lgpd`, `cn-pipl`) — axis A6 in each record. Reconciled 2026-07-04; log: `.fable/reconciliation-log.md`. On conflict, the record wins (see `consent-language.md` §Regulatory Source of Truth).
