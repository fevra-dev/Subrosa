...
| **Sources** | `data-minimization--regulatory-reference.md` · `data-minimization--pipeda-gdpr.md` · `consent-language.md` · `consent-language--rights-language.md` · `consent-language--breach-notification.md` · `consent-language--cookie-consent.md` |
| **Related** | Other US state omnibus laws (CO, CT, VA, UT, TX, MT, OR, DE per `consent-language--cookie-consent.md`) — long-tail candidates, not modeled here. Federal sectoral overlays (COPPA, HIPAA, GLBA, BIPA-IL) registered SECTORAL in master |
...
- Two request-submission methods minimum; 15 business days to process opt-outs (per `consent-language--rights-language.md`).
...
- **Response clock:** 45 days + 45-day extension (notify within first 45) — per `consent-language--rights-language.md`. Opt-outs: 15 business days.
...
- `clock_model:` **none** — CCPA has no regulator-notification duty; § 1798.150 creates breach *liability* (private right of action for unauthorized access resulting from failure to maintain reasonable security). Per `consent-language--breach-notification.md`: "N/A (civil action only)."
...
- Federal overlay: **COPPA** (under 13, verifiable parental consent) — registered SECTORAL; full mechanics in `consent-language--childrens-consent.md`.
