...
| | |
|---|---|
| **Record** | `us-coppa` · **Status:** SECTORAL-OVERLAY (S-profile v1.1) · **Current as of:** 2026-07-17 (verification pass) |
...
- **Notice** (§ 312.5(a) + **§ 312.4 — web-verified 2026-07-17 against eCFR**: direct notice to the parent before collection with context-specific content requirements, plus prominent online notice): home page and every collection point; direct notice to parents.
...
## S4 — Interactions
Layers under CCPA's minor provisions (13–16 opt-in, § 1798.120(c) — verified 2026-07-17) and parallels UK AADC's broader under-18 design duties. **Conflict C5** (`regulatory-taxonomy--conflicts.md`): VPC's verification-data paradox — resolution: ephemeral verification, delete-after-check; architectural end-state: ZKP age/guardianship proofs.
