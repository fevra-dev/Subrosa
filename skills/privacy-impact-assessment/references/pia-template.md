...
> **Source of truth:** statutory anchors in this template (GDPR Arts. 6/9/35, Law 25 Art. 63.5, PIPL Art. 55; HIPAA/AI Act as sectoral overlays) derive from `taxonomy/regulatory-taxonomy.md` records, axis A12. Reconciled 2026-07-04; log: `.fable/reconciliation-log.md`. On conflict, the record wins (see `SKILL.md` §Regulatory Source of Truth).
