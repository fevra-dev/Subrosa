...
## The flag-don't-fix discipline caught five real errors in the original suite
Outcome of the [VERIFY] ledger (resolved 6/6 by primary-source web research, 2026-07-05): the Law 25 72-hour clock was folklore (statute says *promptly*), the POPIA condition table was shifted across its whole range, LGPD's objection anchor was a duplicate, nFADP's "Art. 12" conflated the RoPA with Art. 23(4), the UAE AED 20M figure was uncorroborated — and Vietnam's entire instrument had been superseded (PDPL 91/2025, in force Jan 2026). Every one entered the taxonomy *flagged instead of asserted*, so no downstream artifact ever carried them as fact. Why it matters: normalization didn't just organize the suite — the flag-and-verify loop is what made a hand-authored legal reference falsifiable. Supersession risk (VN) argues for a currency-check cadence on all records, not just reform-watch notes.
