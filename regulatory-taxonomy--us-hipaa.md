...
| **Sources** | `data-minimization--regulatory-reference.md` §HIPAA · `consent-language--breach-notification.md` · `privacy-impact-assessment--dpia-triggers.md` §HIPAA |
...
## S5 — Defined Lists
The **18 PHI identifiers** — full table with nuances: `data-minimization--regulatory-reference.md` §HIPAA (canonical; not duplicated here per source-of-truth rule).
