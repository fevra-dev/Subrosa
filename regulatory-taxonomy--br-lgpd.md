...
## A6 — Rights
Access Art. 18(II) · rectification Art. 18(III) · erasure Art. 18(VI) · portability Art. 18(V) · objection Art. 18(II) `[VERIFY — suite rights matrix maps both Access and Object to Art. 18(II); duplicate mapping looks suspect, confirm objection's true anchor against primary]` · ADM review Art. 20 · free access principle Art. 6(IV). Response clock: **15 days**, no extension listed (per rights matrix). Complaint: gov.br/anpd. Restriction / opt-out-of-sale / limit-sensitive / de-indexing: —. Tag: `PROCEDURAL`.
