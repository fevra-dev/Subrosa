...
> **Source of truth:** this file was a grounding source for the `ca-pipeda-law25`, `eu-gdpr-uk`, and `us-ca-ccpa` taxonomy records (reconciled 2026-07-04). The records are canonical for jurisdiction facts; this file is the field-level companion. Log: `.fable/reconciliation-log.md`. On conflict, the record wins (see `data-minimization.md` §Regulatory Source of Truth).
