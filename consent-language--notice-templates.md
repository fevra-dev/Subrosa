...
> **Source of truth:** statutory anchors in this file derive from `regulatory-taxonomy.md` records (`ca-pipeda-law25`, `eu-gdpr-uk`, `us-ca-ccpa`). Reconciled 2026-07-04; log: `.fable/reconciliation-log.md`. On conflict, the record wins (see `consent-language.md` §Regulatory Source of Truth). Template response-time phrasing ("30 days — GDPR") is a deliberate plain-language rendering of the record's 1-month clock.
