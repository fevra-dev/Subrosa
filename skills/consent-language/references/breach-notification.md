...
> **Source of truth:** the timeline table and thresholds in this file derive from `taxonomy/regulatory-taxonomy.md` records — axis A8 in each record. Reconciled 2026-07-04; log: `.fable/reconciliation-log.md`. On conflict, the record wins (see `SKILL.md` §Regulatory Source of Truth).
