...
| **Sources** | `data-minimization--regulatory-reference.md` §Singapore PDPA · `consent-language--breach-notification.md` |
...
## A12 — DPIA / PIA
`dpia_model:` none statutory — PDPC advisory: DPIAs recommended for significant personal-data processing activities (sourced: `privacy-impact-assessment.md` regime table — upgraded from [UNVERIFIED] 2026-07-04, see reconciliation log). The Act mandates none.
