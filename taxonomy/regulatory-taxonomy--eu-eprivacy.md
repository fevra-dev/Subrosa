...
| **Sources** | `skills/data-minimization/references/regulatory-reference.md` §ePrivacy · `skills/consent-language/references/cookie-consent.md` |
...
## S1 — Enforcement
National DPAs under member-state implementations (CNIL the strictest — sourced: equal-prominence reject, 13-month consent validity; DSK, AEPD, Garante, ICO/PECR positions per `skills/consent-language/references/cookie-consent.md`).
...
## S4 — Interactions
Sits over GDPR (consent definition imported from Art. 4(11)); UK fork via PECR; anti-pattern refusal list (pre-ticks, cookie walls, "by continuing") per Planet49 C-673/17 and `skills/consent-language/references/cookie-consent.md`.
